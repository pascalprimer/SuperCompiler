...
public class BinaryLessEqualExpression extends BinaryExpression {

	private BinaryLessEqualExpression(Type type, Expression leftExp, Expression rightExp) {
	...
	public static Expression getExpression(Expression leftExp, Expression rightExp) {
		if (leftExp.returnType instanceof IntType && rightExp.returnType instanceof IntType) {
			...
			return new BinaryLessEqualExpression(BoolType.getInstance(), leftExp, rightExp);
		}
		if (leftExp.returnType instanceof StringType && rightExp.returnType instanceof StringType) {
			...
			return new FunctionCallExpression(
					AST.globalFunctionTable.getFunctionType("__string_less_equal__"),
